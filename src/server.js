...
📅 เช็กรอบรถ
กด "ดูวันที่ที่มีรอบ" เพื่อเลือกวันที่ต้องการเดินทางค่ะ

🎫 จองตั๋ว
กด "จองผ่านเว็บ" หรือเมนูด้านล่าง ระบบจะพาเลือกทีละขั้นตอนค่ะ

👤 ให้แอดมินช่วย
กด "ติดต่อแอดมิน" ได้เลยค่ะ`, [
    button('ดูวันที่ที่มีรอบ', 'action=check_schedule'),
    uriButton('จองผ่านเว็บ', liffBookingUrl()),
    button('ติดต่อแอดมิน', 'action=contact_admin')
  ]);
}
