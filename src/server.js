...
app.post('/api/liff/bookings', async (req, res) => {
  try {
    if (!isBookingOpen()) return apiError(res, 403, 'ขณะนี้ปิดรับการจองอัตโนมัติแล้ว กรุณารอเริ่มจองใหม่ตอนเช้าเวลา 07.00-22.00 น. หากเร่งด่วนมาก โทร 092-774-4341 ได้ค่ะ แต่อาจไม่สะดวกรับสายในช่วงนอกเวลาทำการ');
